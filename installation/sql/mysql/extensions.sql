...
INSERT INTO `#__guidedtours` (`id`, `asset_id`, `title`, `alias`, `description`, `ordering`, `extensions`, `url`, `overlay`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `published`, `state`) VALUES
...
(1, 1, 'Click here!', '', 1, '<p>This Tour will show you that how you can create a new Guided Tour in Joomla! Backend</p>', 0, 1, 'bottom', '.button-new', '', 0, '2021-09-17 18:35:44', 430, '2021-09-17 18:35:44', 430, 1),
(2, 1, 'Add title for your Tour.', '', 1, '<p>Here you have to add the title of your Tour Step. </p>', 0, 1, 'bottom', '#jform_title', '', 0, '2021-09-17 18:37:55', 430, '2021-09-17 18:37:55', 430, 1),
(3, 1, 'Add Content', '', 1, '<p>Add the content of your Tour here!</p>', 0, 1, 'bottom', '#details', '', 0, '2021-09-17 18:39:09', 430, '2021-09-17 18:39:09', 430, 1),
(4, 1, 'plugin selector', '', 1, '<p>Select the extensions where you want to show your Tour. e.g If you are creating a tour which is only in \'Users\' extensions then select Users here.</p>', 0, 1, 'bottom', '.choices__inner', '', 0, '2021-09-17 18:42:25', 430, '2021-09-17 18:42:25', 430, 1),
(5, 1, 'URL', '', 1, '<p>Add URL of the page from where you want to start your Tour. </p>', 0, 1, 'bottom', '#jform_url', '', 0, '2021-09-17 18:44:26', 430, '2021-09-17 18:48:25', 430, 1),
(6, 1, 'overlay', '', 1, '<p>Select if you want an overlay effect or not.</p>', 0, 1, 'bottom', '#jform_overlay1', '', 0, '2021-09-17 18:45:34', 430, '2021-09-17 18:48:36', 430, 1),
(7, 1, 'save and close', '', 1, '', 0, 1, 'bottom', '#save-group-children-save', '', 0, '2021-09-17 18:46:52', 430, '2021-09-17 18:50:35', 430, 1),
(8, 1, 'Create steps for your Tour', '', 1, '<p>Click on steps icon in the right</p>', 0, 1, 'right', '.btn-info ', '', 0, '2021-09-17 18:52:03', 430, '2021-09-17 18:53:08', 430, 1),
(9, 1, 'Click here!', '', 1, '<p>Click here to create a new Step for your Tour</p>', 0, 1, 'bottom', '.button-new', '', 0, '2021-09-17 18:55:27', 430, '2021-09-17 18:55:27', 430, 1),
...
(11, 1, 'Add Content', '', 1, '<p>Add the content of your Tour here!</p>', 0, 1, 'bottom', '#details', '', 0, '2021-09-17 18:57:19', 430, '2021-09-17 18:57:19', 430, 1),
(12, 1, 'Position ', '', 1, '<p>here add the position of the Step you want. e.g. right, left, top, bottom.</p>', 0, 1, 'bottom', '#jform_position', '', 0, '2021-09-17 18:58:54', 430, '2021-09-17 18:58:54', 430, 1),
(13, 1, 'Target', '', 1, '<p>add the ID name or Class name of the element where you want to attach your Tour.</p>', 0, 1, 'bottom', '#jform_target', '', 0, '2021-09-17 19:00:01', 430, '2021-09-17 19:00:01', 430, 1),
(14, 1, 'Multi-page', '', 1, '<p>Select this if the next step is on different page</p>', 0, 1, 'bottom', '#jform_multipage1', 'http://1', 0, '2021-09-17 19:03:32', 430, '2021-09-17 19:03:32', 430, 1),
(15, 1, 'save and close', '', 1, '<p>save and close the step</p>', 0, 1, 'bottom', '#save-group-children-save', 'http://1', 0, '2021-09-17 19:04:13', 430, '2021-09-17 19:08:35', 430, 1),
(16, 1, 'Congratulations!!!', '', 1, '<p>You successfully created your first Guided Tour!</p>', 0, 1, 'bottom', '.hero-example', 'http://1', 0, '2021-09-17 19:05:44', 430, '2021-09-17 19:05:44', 430, 1);
