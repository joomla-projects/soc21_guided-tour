...
(1, 1, 'Click here!', 1, '<p>This Tour will show you that how you can create a new Guided Tour in Joomla! Backend</p>', 0, 1, 'bottom', '.button-new', '', 430, '', 430),
(2, 1, 'Add title for your Tour.', 1, '<p>Here you have to add the title of your Tour Step. </p>', 0, 1, 'bottom', '#jform_title', '', 430, '', 430),
(3, 1, 'Add Content', 1, '<p>Add the content of your Tour here!</p>', 0, 1, 'bottom', '#details', '', 430, '', 430),
(4, 1, 'plugin selector', 1, '<p>Select the extensions where you want to show your Tour. e.g If you are creating a tour which is only in \'Users\' extensions then select Users here.</p>', 0, 1, 'bottom', '.choices__inner', '', 430, '', 430),
(5, 1, 'URL', 1, '<p>Add URL of the page from where you want to start your Tour. </p>', 0, 1, 'bottom', '#jform_url', '', 430, '', 430),
(6, 1, 'overlay', 1, '<p>Select if you want an overlay effect or not.</p>', 0, 1, 'bottom', '#jform_overlay1', '', 430, '', 430),
(7, 1, 'save and close', 1, '', 0, 1, 'bottom', '#save-group-children-save', '', 430, '', 430),
(8, 1, 'Create steps for your Tour', 1, '<p>Click on steps icon in the right</p>', 0, 1, 'right', '.btn-info ', '', 430, '', 430),
(9, 1, 'Click here!', 1, '<p>Click here to create a new Step for your Tour</p>', 0, 1, 'bottom', '.button-new', '', 430, '', 430),
(10, 1, 'Add title for your Tour.', 1, '<p>Here you have to add the title of your Tour Step. </p>', 0, 1, 'bottom', '#jform_title', '', 430, '', 430),
(11, 1, 'Add Content', 1, '<p>Add the content of your Tour here!</p>', 0, 1, 'bottom', '#details', '', 430, '', 430),
(12, 1, 'Position ', 1, '<p>here add the position of the Step you want. e.g. right, left, top, bottom.</p>', 0, 1, 'bottom', '#jform_position', '', 430, '', 430),
(13, 1, 'Target', 1, '<p>add the ID name or Class name of the element where you want to attach your Tour.</p>', 0, 1, 'bottom', '#jform_target', '', 430, '', 430),
(14, 1, 'Multi-page', 1, '<p>Select this if the next step is on different page</p>', 0, 1, 'bottom', '#jform_multipage1', '', 430, '', 430),
(15, 1, 'save and close', 1, '<p>save and close the step</p>', 0, 1, 'bottom', '#save-group-children-save', '', 430, '', 430),
(16, 1, 'Congratulations!!!', 1, '<p>You successfully created your first Guided Tour!</p>', 0, 1, 'bottom', '.hero-example', '', 430, '', 430);
