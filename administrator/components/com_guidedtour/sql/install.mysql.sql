...
INSERT IGNORE INTO `#__guidedtours` (`id`, `title`, `description`, `distance`, `toilets`, `cafe`, `hills`, `bogs`, `picture`, `width`, `height`, `alt`) VALUES
...
CREATE TABLE IF NOT EXISTS `#__guidedtour_steps` (
  ...
  `state` TINYINT NOT NULL DEFAULT '1',
  KEY `idx_guidedtour` (`guidedtour_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;
...
INSERT IGNORE INTO `#__guidedtour_steps` (`id`, `walk_id`, `date`, `weather`) VALUES
